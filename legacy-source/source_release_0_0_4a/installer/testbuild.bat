...
"C:\Program Files (x86)\Microsoft SDKs\Windows\v7.0a\Bin\mt.exe" -manifest chatpad_installer.exe.manifest -outputresource:"%2\chatpad_installer.exe";#1

:CopyExe

copy /Y %2\chatpad_installer.exe install\%1\chatpad_installer_%2.exe
