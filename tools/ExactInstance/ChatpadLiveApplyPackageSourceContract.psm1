...
function Assert-Inf([string]$Text) {
    ...
    $requiredLines = @(
        ...
        'DriverVer   = 07/13/2026,1.0.14.0','PnpLockdown = 1','ChatpadFilter_CopyFiles = 13','ChatpadFilter.sys = 1,,',
...
function Assert-Plan([object]$Plan, [string]$InfText) {
    ...
    $expectedSourcePaths = @(
        ...
        'src/driver/ChatpadFilter/ChatpadControlDevice.c',
        'src/driver/ChatpadFilter/ChatpadControlDevice.h',
        'src/driver/ChatpadFilter/ChatpadControlInterface.h',
        'src/driver/ChatpadFilter/ChatpadFilterLifecycle.c',
        'src/driver/ChatpadFilter/ChatpadFilterLifecycle.h',
        'src/driver/ChatpadFilter/ChatpadLiveRuntime.c',
        'src/driver/ChatpadFilter/ChatpadLiveRuntime.h',
        ...
        'src/protocol/ChatpadProtocol/ChatpadActivationExecutor.h',
        'src/protocol/ChatpadProtocol/ChatpadConfiguration.c',
        'src/protocol/ChatpadProtocol/ChatpadConfiguration.h',
        'src/protocol/ChatpadProtocol/ChatpadFailOpenPolicy.c',
        'src/protocol/ChatpadProtocol/ChatpadFailOpenPolicy.h',
        'src/protocol/ChatpadProtocol/ChatpadActivationRequests.c',
        'src/protocol/ChatpadProtocol/ChatpadActivationRequests.h',
        'src/protocol/ChatpadProtocol/ChatpadActivationSequence.c',
        'src/protocol/ChatpadProtocol/ChatpadActivationSequence.h',
        'src/protocol/ChatpadProtocol/ChatpadKeyboardHid.c',
        'src/protocol/ChatpadProtocol/ChatpadKeyboardHid.h',
        'src/protocol/ChatpadProtocol/ChatpadKeyboardParser.c',
        'src/protocol/ChatpadProtocol/ChatpadKeyboardParser.h',
        'src/protocol/ChatpadProtocol/ChatpadLiveTransferPolicy.c',
        'src/protocol/ChatpadProtocol/ChatpadLiveTransferPolicy.h',
        ...
        'src/transport/ChatpadWdfControlSetup/ChatpadWdfControlSetupFormatter.c',
        'src/transport/ChatpadWdfControlSetup/ChatpadWdfControlSetupFormatter.h')
    ...
    Assert-String $Plan.version_policy.source_driver_ver '07/13/2026,1.0.14.0' 'source DriverVer'
