...
function Assert-Inf([string]$Text) {
    ...
    $requiredLines = @(
        ...
        'DriverVer   = 07/12/2026,1.0.1.0','PnpLockdown = 1','ChatpadFilter_CopyFiles = 13','ChatpadFilter.sys = 1,,',
...
function Assert-Plan([object]$Plan, [string]$InfText) {
    ...
    Assert-String $Plan.version_policy.source_driver_ver '07/12/2026,1.0.1.0' 'source DriverVer'
