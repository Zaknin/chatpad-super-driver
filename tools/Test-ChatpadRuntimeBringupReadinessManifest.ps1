...
function Get-ChatpadTask8GExpectedScalars {
    [ordered]@{
        schema='chatpad-one-shot-native-execution-coordinator-evidence-v2';status='ATOMIC_ONE_SHOT_EXECUTION_COORDINATOR_SOURCE_PRESENT_GENUINE_RECORDING_PROVIDER_ONLY_PRODUCTION_PROVIDER_NOT_SELECTED_OR_CONSTRUCTED_NO_NATIVE_EXECUTION_NO_BINDING_NO_MUTATION_LIVE_EXECUTION_UNAUTHORIZED';readiness='READY_FOR_INDEPENDENT_SOURCE_AUDIT_ONLY';created_from_task='TASK 8G-1R4A2B';starting_branch='feature/native-adapter-production-backend-source';starting_commit='9147f0af7e8fa8da581554427ebd51908e5d924e';implementation_branch='feature/native-adapter-execution-coordinator';atomic_implementation_commit='182ba40a0ccb39974838730f324a9c9ce41b8475';implementation_commit_parent='fe205ca346af2000d9adffb96ac9b4c275484c61';implementation_commit_subject='fix: implement atomic coordinator authorization primitive';coordinator_path='tools/ExactInstance/ChatpadOneShotNativeExecutionCoordinator.psm1';coordinator_byte_size=7469;coordinator_sha256='0D2196F14CB1D55DB0DBAFC62D3A065511E7990C37EF766DD0CB30AFF0781A42';managed_helper_path='tools/ExactInstance/ChatpadOneShotAuthorizationRegistry.cs';managed_helper_byte_size=1255;managed_helper_sha256='D672C78AAF7AD75DF21B70B7BF20A902A9E974787CD6BEF50CEFC6F1FD899BEB';focused_test_path='tools/Test-ChatpadOneShotNativeExecutionCoordinator.ps1';focused_test_byte_size=15959;focused_test_sha256='67B3E0B9FA52B234A18494EDB83249AE39D14A5B213DA252297BF2D9A15A3EB0';task_8e_evidence_path='docs/evidence/native-adapter-nonexecuting-implementation-task-8e-1.json';task_8e_evidence_sha256='493C80C445B9D3903D70509AA704177396172B139CCDD037195D4FA84AA9FB6F';task_8f_evidence_path='docs/evidence/native-adapter-production-backend-source-task-8f-1.json';task_8f_evidence_sha256='93B0D93E63FA43A9D5C7EE647BD5E261085CD3A4F47F5CD4FD4D1DFA01800042';capability_mechanism='REFERENCE_KEYED_OFFLINE_RECORDING_AUTHORIZATION';authorization_registry_mechanism='CONDITIONAL_WEAK_TABLE_WITH_INTERLOCKED_COMPARE_EXCHANGE';provider_provenance_mechanism='INTERNAL_TASK_8F_RECORDING_PROVIDER_REFERENCE';atomic_consumption_primitive='System.Threading.Interlocked.CompareExchange';same_process_concurrency_mechanism='TWO_POWERSHELL_RUNSPACES_SHARING_ONE_MANAGED_CONDITIONAL_WEAK_TABLE_REGISTRY';caller_supplied_provider_accepted=$false;arbitrary_provider_registration_allowed=$false;production_provider_bindable_by_test_factory=$false;provider_stored_in_authorization_record=$true;provider_selected_from_caller_input=$false;provider_provenance_uses_reference_identity=$true;recording_provider_created_internally=$true;consumption_atomic=$true;consume_before_provider_call=$true;concurrency_test_uses_actual_registry=$true;race_iteration_count=1;concurrent_contender_count=2;concurrent_winner_count=1;concurrent_provider_entry_count=1;concurrent_replay_rejection_count=1;replay_after_success_rejected=$true;replay_after_provider_failure_rejected=$true;replay_after_exception_rejected=$true;replay_after_cleanup_failure_rejected=$true;request_transfer_rejected=$true;provider_substitution_rejected=$true;wrapper_authorization_rejected=$true;deserialized_authorization_rejected=$true;forged_type_authorization_rejected=$true;string_authorization_rejected=$true;boolean_authorization_rejected=$true;accepted_operation='APPLY';shared_container_id='{828F4587-006F-5AD1-B169-6AF57905DFDE}';operator_confirmation_id='operator-confirmation-c445630fbb303c7c';recording_provider_plan_entry_count=13;recording_provider_plan_identity='TASK_8F_13_STEP_RECORDING_PLAN';failure_stop_behavior='SIMULATED_FAILURE_STOPS_NORMAL_STEPS';cleanup_behavior='TASK_8F_REQUIRED_CLEANUP_RECORDED';thrown_exception_behavior='TEST_LOCAL_RECORDING_PROVIDER_CALL_WRAPPER_THROWS_AFTER_GENUINE_RECORDING_ENTRY';cleanup_failure_behavior='TEST_LOCAL_RECORDING_PROVIDER_CALL_WRAPPER_THROWS_AFTER_GENUINE_CLEANUP_ENTRY';production_provider_selected=$false;production_provider_constructed=$false;production_provider_loaded=$false;production_provider_invoked=$false;execution_authorized=$false;native_execution_performed=$false;binding_performed=$false;windows_mutation_performed=$false;powershell_7_result='PASS';powershell_7_test_count=23;powershell_7_assertion_count=105;windows_powershell_result='PASS';windows_powershell_test_count=23;windows_powershell_assertion_count=105;device_query_count=0;native_invocation_count=0;setupapi_newdev_invocation_count=0;binding_count=0;windows_mutation_count=0;driver_action_count=0;rollback_count=0;restore_count=0;artifact_compile_output_access_count=0;artifact_access_count=0;compile_output_access_count=0;live_readiness='BLOCKED';remaining_blocker='BLOCKED_NATIVE_ADAPTER_EXECUTION_COORDINATOR_NOT_INDEPENDENTLY_AUDITED';ready_for_independent_audit_only=$true;ready_for_native_execution=$false
    }
}

function Get-ChatpadTask8GExpectedArrays {
    [ordered]@{
        public_exports=@('Get-ChatpadNonExecutingNativeAdapterContract','Test-ChatpadNonExecutingNativeAdapterRequest','Invoke-ChatpadNonExecutingNativeAdapter','New-ChatpadNativeAdapterFakeRecordingBackend');private_coordinator_surface=@('Get-OneShotCoordinatorConstants','Get-OneShotRequestFingerprint','Test-OneShotExecutionRequest','New-TestOnlyRecordingProviderAuthorization','Invoke-OneShotNativeExecutionCoordinator');managed_authorization_helper_surface=@('Chatpad.OneShotAuthorization.Registry.Register','Chatpad.OneShotAuthorization.Registry.TryConsume');request_binding_fields=@('operation','ordered_target_chain','container_id','operator_confirmation_id','task_8e_evidence_identity','task_8f_evidence_identity','registered_recording_provider_reference');accepted_ordered_target_chain=@('USB\VID_045E&PID_028E\1C21F10','USB\VID_045E&PID_028E&IG_00\8&2AF61D70&1&00','HID\VID_045E&PID_028E&IG_00\9&2E72F677&0&0000');recording_provider_plan=@('SetupDiCreateDeviceInfoList','SetupDiOpenDeviceInfoW','SetupDiGetDeviceInstanceIdW','SetupDiGetDevicePropertyW','SetupDiGetDeviceRegistryPropertyW','SetupDiBuildDriverInfoList','SetupDiEnumDriverInfoW','SetupDiGetDriverInfoDetailW','SetupDiGetDriverInstallParamsW','SetupDiSetSelectedDriverW','DiInstallDevice','SetupDiDestroyDriverInfoList','SetupDiDestroyDeviceInfoList');outcome_inventory=@('replay_after_success_rejected','replay_after_provider_failure_rejected','replay_after_thrown_exception_rejected','replay_after_cleanup_failure_rejected','request_transfer_rejected','provider_substitution_rejected','wrapper_authorization_rejected','deserialized_authorization_rejected','forged_type_authorization_rejected','string_authorization_rejected','boolean_authorization_rejected')
    }
}
...
function Test-ChatpadTask8GManifestEvidence {
    ...
    $expected=Get-ChatpadTask8GExpectedScalars;$arrays=Get-ChatpadTask8GExpectedArrays;$manifestIdentity=[ordered]@{evidence_path='docs/evidence/one-shot-native-execution-coordinator-task-8g-1.json';evidence_byte_size=7022;evidence_sha256='A3286E336EA3F7AAB8785D3D0C39D8E6A50F8DA5AF165981DAB9E2483AC013E1'}
    ...
    foreach($identity in @(@{path='tools/ExactInstance/ChatpadOneShotNativeExecutionCoordinator.psm1';size=7469;hash='0D2196F14CB1D55DB0DBAFC62D3A065511E7990C37EF766DD0CB30AFF0781A42';prefix='coordinator'},@{path='tools/ExactInstance/ChatpadOneShotAuthorizationRegistry.cs';size=1255;hash='D672C78AAF7AD75DF21B70B7BF20A902A9E974787CD6BEF50CEFC6F1FD899BEB';prefix='managed_helper'},@{path='tools/Test-ChatpadOneShotNativeExecutionCoordinator.ps1';size=15959;hash='67B3E0B9FA52B234A18494EDB83249AE39D14A5B213DA252297BF2D9A15A3EB0';prefix='focused_test'})){
    ...
    if((Get-Item -LiteralPath $evidencePath).Length-ne7022){$defects.Add('evidence.byte_size: mismatch')};if((Get-FileHash -LiteralPath $evidencePath -Algorithm SHA256).Hash-cne'A3286E336EA3F7AAB8785D3D0C39D8E6A50F8DA5AF165981DAB9E2483AC013E1'){$defects.Add('evidence.sha256: mismatch')}
    ...
    foreach($pair in $arrays.GetEnumerator()){
        ...
        foreach($defect in (Get-ChatpadExactOrdinalArrayValueDefects -ExpectedValues (Get-ChatpadTask8EValue $section $pair.Key) -ActualValues (Get-ChatpadTask8EValue $evidence $pair.Key) -FieldName "manifest-evidence.$($pair.Key)").defects){$defects.Add($defect)}
    }
    [pscustomobject]@{result=if($defects.Count){'FAIL'}else{'PASS'};defect_count=$defects.Count;defects=@($defects)}
}
...
function Invoke-ChatpadTask8GRegression {
    ...
    try{
        ...
        foreach($pair in $arrays.GetEnumerator()){
            $field=$pair.Key;$cases.Add([pscustomobject]@{id="$field-removed";expected="section.$field";mutate=({param($m,$e,$f)$m.one_shot_native_execution_coordinator.$f=@($m.one_shot_native_execution_coordinator.$f|Select-Object -Skip 1)}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-added";expected="section.$field";mutate=({param($m,$e,$f)$m.one_shot_native_execution_coordinator.$f=@($m.one_shot_native_execution_coordinator.$f)+@('TASK8G_UNAUTHORIZED_ADDED_ENTRY')}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-reordered";expected="section.$field";mutate=({param($m,$e,$f)$v=@($m.one_shot_native_execution_coordinator.$f);$x=$v[0];$v[0]=$v[1];$v[1]=$x;$m.one_shot_native_execution_coordinator.$f=$v}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-changed";expected="section.$field";mutate=({param($m,$e,$f)$v=@($m.one_shot_native_execution_coordinator.$f);$v[0]='TASK8G_CHANGED_ENTRY';$m.one_shot_native_execution_coordinator.$f=$v}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-duplicated";expected="section.$field";mutate=({param($m,$e,$f)$v=@($m.one_shot_native_execution_coordinator.$f);$v[1]=$v[0];$m.one_shot_native_execution_coordinator.$f=$v}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-scalar";expected="section.$field";mutate=({param($m,$e,$f)$m.one_shot_native_execution_coordinator.$f='TASK8G_SCALAR'}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-null";expected="section.$field";mutate=({param($m,$e,$f)$m.one_shot_native_execution_coordinator.$f=$null}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-empty";expected="section.$field";mutate=({param($m,$e,$f)$m.one_shot_native_execution_coordinator.$f=@()}).GetNewClosure();field=$field});$cases.Add([pscustomobject]@{id="$field-manifest-evidence-disagreement";expected="manifest-evidence.$field";mutate=({param($m,$e,$f)$v=@($e.$f);$v[0]='TASK8G_MANIFEST_EVIDENCE_MISMATCH';$e.$f=$v}).GetNewClosure();field=$field})
        }
