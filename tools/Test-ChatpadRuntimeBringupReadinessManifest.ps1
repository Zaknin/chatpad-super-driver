...
if($inventoryDefectCount -or $inventoryCounts.tracked_ps1_count -ne 41 -or $inventoryCounts.tracked_psm1_count -ne 2 -or $inventoryCounts.tracked_powershell_count -ne 43 -or $inventoryCounts.parsed_ps1_count -ne 41 -or $inventoryCounts.parsed_psm1_count -ne 2 -or $inventoryCounts.parsed_powershell_count -ne 43 -or $inventoryCounts.parse_error_count -ne 0 -or $inventoryCounts.duplicate_normalized_path_count -ne 0 -or $inventoryCounts.missing_count -ne 0 -or $inventoryCounts.extra_count -ne 0){$defects.powershell_inventory++}
