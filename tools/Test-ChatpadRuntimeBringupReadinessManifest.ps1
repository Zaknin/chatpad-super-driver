...
function Test-ChatpadTask8GManifestEvidence {
    ...
    if($continuityDocFiles.Count-eq$continuityDocPaths.Count){
        ...
        foreach($requiredPattern in @('TASK 8G-2 passed','execution-coordinator source lane\s+is\s+closed','79ec174dabd7e73f2d01021168921021bc118702','BLOCKED_NATIVE_ADAPTER_LOCAL_DEVELOPMENT_PACKAGE_NOT_INDEPENDENTLY_AUDITED_AND_LOCAL_INSTALLATION_PATH_NOT_OBSERVED','TASK 8I-P1B-LD-R2[\s\S]{1,220}Independent read-only audit of the unsigned canonical package and local-development deployment contract')){if($continuityText -notmatch$requiredPattern){$defects.Add("continuity.task8g: missing-required:$requiredPattern")}}
    }
    $evidencePath=[IO.Path]::GetFullPath((Join-Path $RepositoryRoot ([string](Get-ChatpadTask8EValue $section 'evidence_path'))))
...
function Test-ChatpadUnsignedPackageManifestEvidence {
    ...
    if($null-eq$section-or$section-is[array]-or$section-is[string]){return[pscustomobject]@{result='FAIL';defect_count=1;defects=@('section: missing-or-wrong-type')}}
    $expected=[ordered]@{
        evidence_path='docs/evidence/canonical-live-apply-package-build-task-8i-p1b-2a.json';evidence_byte_size=18015;evidence_sha256='F7065F15615973926BACD2C6A19C13A71381254BE6E4B1BA4D0B674532CF884E';contract_path='tools/ExactInstance/contracts/chatpad-live-apply-unsigned-package-plan.json';contract_byte_size=6385;contract_sha256='C7782C33295C897CC7431996A8ACB9AEF4D5C298F9E1CB991B75886C0D9162F5';focused_test_path='tools/Test-ChatpadLiveApplyPackageSourceContract.ps1';focused_test_byte_size=34251;focused_test_sha256='E41B975245974536C8F3DB08FA7D46D623E119E142A6167452678AEB481A9DD1';schema='chatpad-canonical-live-apply-package-build-evidence-v1';status='CANONICAL_WINDOWS_11_DRIVER_PACKAGE_BUILT_AND_CATALOGED_UNSIGNED_FOR_LOCAL_DEVELOPMENT_NOT_STAGED_NOT_INSTALLED_NOT_LOADED_NOT_INDEPENDENTLY_AUDITED';readiness='READY_FOR_LOCAL_DEVELOPMENT_PACKAGE_AND_DEPLOYMENT_CONTRACT_AUDIT_ONLY';source_commit='4510e1f2f8a4b4e31ac40672261cf4ad94ec27c5';driver_project_path='src/driver/ChatpadFilter/ChatpadFilter.vcxproj';driver_project_sha256='5641815C63FBB0C2A7442E555A1B70F3BE4C22014DF2BA29A29E987A2D903112';inf_byte_size=1581;inf_sha256='0200FCF5E1B26F4A594ECEF936DAAEC4B8F2BC5743A9DDAE212AD8F99D05E2FC';sys_byte_size=40960;sys_sha256='E4E7BCA837F6B0C662A24CFDDC260D781FDA85E0B37CAE470D65A9716DB174BB';catalog_byte_size=1202;catalog_sha256='6F0ABF84AE68010008A0360D4DDF716E644DD8D63E669F3AA96F27047EF613FD';accepted_build_count=2;sys_reproducible=$true;architecture='AMD64';sys_signature_state='unsigned';catalog_signature_state='unsigned';deployment_scope='LOCAL_DEVELOPMENT_ONLY';current_required_route='CONTROLLED_LOCAL_DEVELOPMENT_INSTALLATION';production_distribution_signing_required=$false;production_distribution_signing='OUT_OF_SCOPE_OPTIONAL_FUTURE_WORK';production_distribution_objective_classification='OUT_OF_SCOPE_FOR_CURRENT_LOCAL_DEVELOPMENT_OBJECTIVE';current_installability='NOT_CURRENTLY_INSTALLABLE_LOCAL_METHOD_AND_ENFORCEMENT_STATE_NOT_OBSERVED';package_signed=$false;package_staged=$false;package_installed=$false;driver_loaded=$false;local_installation_method='NOT_YET_OBSERVED';local_signature_enforcement_state='NOT_YET_OBSERVED';local_candidate_identity='NOT_YET_OBSERVED';local_published_inf_name='NOT_YET_OBSERVED';ordinary_production_signature_enforcement_loadability_claimed=$false;host_readiness_observation_performed=$false;test_certificate_present=$false;blocker='BLOCKED_NATIVE_ADAPTER_LOCAL_DEVELOPMENT_PACKAGE_NOT_INDEPENDENTLY_AUDITED_AND_LOCAL_INSTALLATION_PATH_NOT_OBSERVED';next_task='TASK 8I-P1B-LD-R2 — Independent read-only audit of the unsigned canonical package and local-development deployment contract';file_signing_count=0;staging_count=0;installation_count=0;native_invocation_count=0;device_query_count=0;binding_count=0;authorization_count=0;windows_mutation_count=0
    }
...
if($manifest.schema_version-ne'chatpad-runtime-bringup-readiness-manifest-v4'-or$manifest.real_artifact_static_metadata_review_completed-ne$true-or$manifest.framework_status-ne'PASS'-or$manifest.live_installation_readiness-ne'BLOCKED'-or$manifest.current_gate-ne'BLOCKED_NATIVE_ADAPTER_LOCAL_DEVELOPMENT_PACKAGE_NOT_INDEPENDENTLY_AUDITED_AND_LOCAL_INSTALLATION_PATH_NOT_OBSERVED'-or$manifest.capability_blocker-ne'BLOCKED_NATIVE_ADAPTER_LOCAL_DEVELOPMENT_PACKAGE_NOT_INDEPENDENTLY_AUDITED_AND_LOCAL_INSTALLATION_PATH_NOT_OBSERVED'-or$manifest.live_adapter_status-ne'SCAFFOLD_NON_EXECUTING'-or$manifest.live_binding_authorized-ne$false-or$manifest.manifest_generation_mode-notin@('NO_ARTIFACT_OPEN_DESIGN_GATE_AUDIT','STANDARD_READINESS_RESULT')){$defects.top_level++}
