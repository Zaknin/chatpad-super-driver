...
if($manifest.schema_version-ne'chatpad-runtime-bringup-readiness-manifest-v3'-or$manifest.framework_status-ne'PASS'-or$manifest.live_installation_readiness-ne'BLOCKED'-or$manifest.current_gate-ne'BLOCKED_PENDING_INDEPENDENT_REAUDIT'-or$manifest.capability_blocker-ne'BLOCKED_LIVE_ADAPTER_NOT_IMPLEMENTED'-or$manifest.live_adapter_status-ne'NOT_IMPLEMENTED'-or$manifest.live_binding_authorized-ne$false){$defects.top_level++}
...
if([string]$manifest.readiness.exact_instance_framework_result-ne'PASS'-or$readinessCounts.exact_instance_offline_test_count-ne64-or$readinessCounts.exact_instance_offline_assertion_count-ne263-or$readinessCounts.synthetic_exact_binding_attempt_count-le0-or$readinessCounts.synthetic_exact_restoration_attempt_count-le0-or$readinessCounts.synthetic_exact_restart_attempt_count-ne0){$defects.unsupported_pass++}
