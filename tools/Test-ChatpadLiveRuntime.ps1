...
Check ($inf.Contains('USB\VID_045E&PID_028E') -and $inf.Contains('DriverVer   = 07/12/2026,1.0.4.0')) 'INF targets exact device at version 1.0.4.0'
...
Check ($runtime.Contains('vhfConfig.VersionNumber = 0x0104')) 'VHF child version matches package version 1.0.4.0'
