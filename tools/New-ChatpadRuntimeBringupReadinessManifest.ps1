...
$manifest=[pscustomobject][ordered]@{
    ...
    native_adapter_execution_design_gate=[pscustomobject][ordered]@{
        ...
        fail_closed_scaffolding_implementation_commit='7560fc242a39228d6a95f42ff908bb4be438d6ad'
        fail_closed_scaffolding_audit_status='NATIVE_ADAPTER_FAIL_CLOSED_SCAFFOLDING_AUDIT_ACCEPTED_NO_NATIVE_IO'
        fail_closed_scaffolding_audit_acceptance_commit='748ba24b3e795cd70b3325b6a54fb88569427ed6'
        fail_closed_scaffolding_audit_remediation_commit='af41a8eaeea96dcbcad75fb2e261c4352b2a468e'
        non_live_implementation_status='NATIVE_ADAPTER_NON_LIVE_PLAN_IMPLEMENTED_NO_NATIVE_IO'
        non_live_implementation_commit='4522510a17354fe53d163546e16ff24af5fa0374'
        non_live_implementation_audit_status='NATIVE_ADAPTER_NON_LIVE_PLAN_AUDIT_ACCEPTED_NO_NATIVE_IO'
        non_live_implementation_audit_target_commit='5e7a6f39d0363121b8bd3f6e4b38ceb517889679'
        non_live_implementation_audit_required=$false
        execution_envelope_verifier=[pscustomobject][ordered]@{
            schema_version='chatpad-native-adapter-execution-envelope-verifier-v1'
            status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_IMPLEMENTED_NO_NATIVE_IO'
            opened_from_closed_boundary_commit='68099a441db5f8b517dbeb296ab234a9ee639bdb'
            implementation_commit_recorded=$false
            independent_implementation_audit_required=$false
            audit_acceptance_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_AUDIT_ACCEPTED_NO_NATIVE_IO'
            accepted_audit_target_commit='4849d1959cab9c289952655eb73e3279117779d2'
            accepted_audit_target_parent_commit='68099a441db5f8b517dbeb296ab234a9ee639bdb'
            audit_acceptance_audit_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_AUDIT_ACCEPTANCE_AUDIT_PASS_NO_NATIVE_IO'
            audit_acceptance_audit_target_commit='b6bdd01588e9d72113dd9b09fcfa9baf2026424d'
            audit_pass_recorded_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_AUDIT_PASS_RECORDED_NO_NATIVE_IO'
            audit_pass_recorded_target_commit='f235879fe6d74dcc02dfe2e56297ef14e5a48800'
            audit_pass_accepted_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_AUDIT_PASS_ACCEPTED_NO_NATIVE_IO'
            audit_pass_accepted_target_commit='b64a672984b6e7db16765f13de385b22f3491f11'
            audit_pass_acceptance_audit_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_AUDIT_PASS_ACCEPTANCE_AUDIT_PASS_NO_NATIVE_IO'
            audit_pass_acceptance_audit_target_commit='75a083a684c79b729de04c770371fb6190c9c9e7'
            audit_pass_acceptance_audit_accepted_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_AUDIT_PASS_ACCEPTANCE_AUDIT_ACCEPTED_NO_NATIVE_IO'
            audit_pass_acceptance_audit_accepted_target_commit='ba952444d9d3e306da8985e25b93b74aa5f6cff6'
            lane_closeout_status='NATIVE_ADAPTER_EXECUTION_ENVELOPE_VERIFIER_LANE_CLOSED_NO_NATIVE_IO'
            lane_closeout_audit_target_commit='e271e5c8dd464ba0aeee82e4dc163b12ae28b8de'
            prior_audit_pass_acceptance_audit_accepted_target_commit='ba952444d9d3e306da8985e25b93b74aa5f6cff6'
            prior_audit_pass_acceptance_audit_target_commit='75a083a684c79b729de04c770371fb6190c9c9e7'
            prior_audit_pass_record_target_commit='f235879fe6d74dcc02dfe2e56297ef14e5a48800'
            prior_audit_pass_transition_target_commit='b6bdd01588e9d72113dd9b09fcfa9baf2026424d'
            prior_verifier_implementation_audit_target_commit='4849d1959cab9c289952655eb73e3279117779d2'
            audit_acceptance_recorded=$true
            audit_acceptance_grants_execution_authority=$false
            declared_field_validation_only=$true
            supported_operation_classes=@('Apply','Restore','Restart')
            missing_envelope_result='BLOCKED'
            malformed_envelope_result='BLOCKED'
            stale_envelope_result='BLOCKED'
            future_live_envelope_result='BLOCKED'
            structurally_complete_envelope_result='BLOCKED'
            complete_envelope_authorizes_execution=$false
            ...
            static_metadata_parser_invoked=$false
            ...
            no_artifact_io_traced_function_count=23
            no_artifact_io_forbidden_command_count=0
            no_artifact_io_forbidden_member_count=0
        }
        current_gate='BLOCKED_NATIVE_ADAPTER_EXECUTION_NOT_IMPLEMENTED'
        ...
        execution_scope_boundary=[pscustomobject][ordered]@{
            ...
            audit_acceptance_status='NATIVE_ADAPTER_EXECUTION_SCOPE_BOUNDARY_AUDIT_ACCEPTED_NO_NATIVE_IO'
            ...
            closeout_identity_audit_acceptance_status='NATIVE_ADAPTER_EXECUTION_BOUNDARY_CLOSEOUT_IDENTITY_AUDIT_ACCEPTED_NO_NATIVE_IO'
            closeout_identity_audit_acceptance_target='9c9af5cf0cfdffde67a0f2b4e41e8eceb42d673f'
            final_lane_closeout_status='NATIVE_ADAPTER_EXECUTION_SCOPE_BOUNDARY_LANE_CLOSED_NO_NATIVE_IO'
            final_lane_closeout_audit_target='f7f6041d6987ea8e3752546bd4c9116c88fbe56a'
        ...
        audit_acceptance=[pscustomobject][ordered]@{
            ...
            failed_audit_target='dddd4afab914c1929de5683d6822fde5cbf46c6a'
            failed_audit_finding='FAIL_CLOSED_PROBES_REACHED_COMPILE_OUTPUT_VALIDATION_AND_HASHED_REAL_DLL'
            remediation_result='UNSAFE_ARTIFACT_HASHING_PATH_REMOVED'
            evidence_mode='EVIDENCE_RECORD_ONLY_NO_ARTIFACT_IO'
            transitive_function_count=17
            record_only_validator_reachable=$true
            full_compile_output_validator_reachable_count=0
            get_file_hash_reachable_count=0
            output_enumeration_reachable_count=0
            native_or_file_loading_member_reachable_count=0
            fixed_tracked_json_read_count=2
            windows_powershell_no_artifact_io_regression='PASS'
            powershell_7_no_artifact_io_regression='PASS'
            windows_powershell_blocked_operation_count=3
            powershell_7_blocked_operation_count=3
            missing_or_malformed_evidence_fails_closed=$true
            full_compile_output_validator_run=$false
            static_metadata_parser_run=$false
            real_dll_accessed=$false
            native_library_loaded=$false
            native_entry_point_resolved=$false
            setupapi_newdev_invoked=$false
            device_queried=$false
            windows_mutated=$false
